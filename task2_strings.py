...
# Part a
game_name = video_game_sales[4][NAME]  # 5th game (index 4)
pokemon_word = game_name[0:7]          # "Pokemon"
print(pokemon_word)
...
best_name = video_game_sales[0][NAME]
best_year = video_game_sales[0][YEAR]
best_global = video_game_sales[0][GLOBAL_SALES]

print(f"#1 Best Seller: {best_name} ({best_year}) - ${best_global}M global sales")
